...
MODEL_OPTIONS = [
    ...
    *[
    ...
    dict(model_code="nano_banana_pro", kind=ModelOptionKind.quality, code="4k", label="4K",
         provider_params={"resolution": "4K"},
         credits_multiplier=2.0, is_default=False, sort_order=30),
    # --- Формат кадра (aspect_ratio) -- все множители 1.0: на цену не влияет ---
    # Видео тарифицируется секундами и разрешением, flux/nano-banana -- плоско за
    # картинку. Enum-значения и дефолты выверены по OpenAPI-схемам fal 2026-07-17.
    dict(model_code="wan_video", kind=ModelOptionKind.aspect_ratio, code="16_9", label="16:9",
         provider_params={"aspect_ratio": "16:9"},
         credits_multiplier=1.0, is_default=True, sort_order=10),
    dict(model_code="wan_video", kind=ModelOptionKind.aspect_ratio, code="9_16", label="9:16",
         provider_params={"aspect_ratio": "9:16"},
         credits_multiplier=1.0, is_default=False, sort_order=20),
    dict(model_code="wan_video", kind=ModelOptionKind.aspect_ratio, code="1_1", label="1:1",
         provider_params={"aspect_ratio": "1:1"},
         credits_multiplier=1.0, is_default=False, sort_order=30),
    dict(model_code="kling_video", kind=ModelOptionKind.aspect_ratio, code="16_9", label="16:9",
         provider_params={"aspect_ratio": "16:9"},
         credits_multiplier=1.0, is_default=True, sort_order=10),
    dict(model_code="kling_video", kind=ModelOptionKind.aspect_ratio, code="9_16", label="9:16",
         provider_params={"aspect_ratio": "9:16"},
         credits_multiplier=1.0, is_default=False, sort_order=20),
    dict(model_code="kling_video", kind=ModelOptionKind.aspect_ratio, code="1_1", label="1:1",
         provider_params={"aspect_ratio": "1:1"},
         credits_multiplier=1.0, is_default=False, sort_order=30),
    # Veo: только 16:9 и 9:16 -- квадрата в схеме fal нет.
    dict(model_code="veo_video", kind=ModelOptionKind.aspect_ratio, code="16_9", label="16:9",
         provider_params={"aspect_ratio": "16:9"},
         credits_multiplier=1.0, is_default=True, sort_order=10),
    dict(model_code="veo_video", kind=ModelOptionKind.aspect_ratio, code="9_16", label="9:16",
         provider_params={"aspect_ratio": "9:16"},
         credits_multiplier=1.0, is_default=False, sort_order=20),
    # Ovi: аспект живёт в resolution фиксированными парами пикселей (своей ручки
    # aspect_ratio нет). Цена плоская за видео, дефолт fal = 992x512. Из семи пар
    # берём три понятных; точных 16:9 у провайдера не существует.
    dict(model_code="ovi_video", kind=ModelOptionKind.aspect_ratio, code="wide", label="Горизонтальный",
         provider_params={"resolution": "992x512"},
         credits_multiplier=1.0, is_default=True, sort_order=10),
    dict(model_code="ovi_video", kind=ModelOptionKind.aspect_ratio, code="tall", label="Вертикальный",
         provider_params={"resolution": "512x992"},
         credits_multiplier=1.0, is_default=False, sort_order=20),
    dict(model_code="ovi_video", kind=ModelOptionKind.aspect_ratio, code="square", label="Квадрат",
         provider_params={"resolution": "720x720"},
         credits_multiplier=1.0, is_default=False, sort_order=30),
    dict(model_code="flux_kontext_pro", kind=ModelOptionKind.aspect_ratio, code="1_1", label="1:1",
         provider_params={"aspect_ratio": "1:1"},
         credits_multiplier=1.0, is_default=True, sort_order=10),
    dict(model_code="flux_kontext_pro", kind=ModelOptionKind.aspect_ratio, code="16_9", label="16:9",
         provider_params={"aspect_ratio": "16:9"},
         credits_multiplier=1.0, is_default=False, sort_order=20),
    dict(model_code="flux_kontext_pro", kind=ModelOptionKind.aspect_ratio, code="9_16", label="9:16",
         provider_params={"aspect_ratio": "9:16"},
         credits_multiplier=1.0, is_default=False, sort_order=30),
    dict(model_code="flux_kontext_pro", kind=ModelOptionKind.aspect_ratio, code="4_3", label="4:3",
         provider_params={"aspect_ratio": "4:3"},
         credits_multiplier=1.0, is_default=False, sort_order=40),
    dict(model_code="flux_kontext_pro", kind=ModelOptionKind.aspect_ratio, code="3_4", label="3:4",
         provider_params={"aspect_ratio": "3:4"},
         credits_multiplier=1.0, is_default=False, sort_order=50),
    dict(model_code="nano_banana", kind=ModelOptionKind.aspect_ratio, code="1_1", label="1:1",
         provider_params={"aspect_ratio": "1:1"},
         credits_multiplier=1.0, is_default=True, sort_order=10),
    dict(model_code="nano_banana", kind=ModelOptionKind.aspect_ratio, code="16_9", label="16:9",
         provider_params={"aspect_ratio": "16:9"},
         credits_multiplier=1.0, is_default=False, sort_order=20),
    dict(model_code="nano_banana", kind=ModelOptionKind.aspect_ratio, code="9_16", label="9:16",
         provider_params={"aspect_ratio": "9:16"},
         credits_multiplier=1.0, is_default=False, sort_order=30),
    dict(model_code="nano_banana", kind=ModelOptionKind.aspect_ratio, code="4_3", label="4:3",
         provider_params={"aspect_ratio": "4:3"},
         credits_multiplier=1.0, is_default=False, sort_order=40),
    dict(model_code="nano_banana", kind=ModelOptionKind.aspect_ratio, code="3_4", label="3:4",
         provider_params={"aspect_ratio": "3:4"},
         credits_multiplier=1.0, is_default=False, sort_order=50),
    dict(model_code="nano_banana_pro", kind=ModelOptionKind.aspect_ratio, code="1_1", label="1:1",
         provider_params={"aspect_ratio": "1:1"},
         credits_multiplier=1.0, is_default=True, sort_order=10),
    dict(model_code="nano_banana_pro", kind=ModelOptionKind.aspect_ratio, code="16_9", label="16:9",
         provider_params={"aspect_ratio": "16:9"},
         credits_multiplier=1.0, is_default=False, sort_order=20),
    dict(model_code="nano_banana_pro", kind=ModelOptionKind.aspect_ratio, code="9_16", label="9:16",
         provider_params={"aspect_ratio": "9:16"},
         credits_multiplier=1.0, is_default=False, sort_order=30),
    dict(model_code="nano_banana_pro", kind=ModelOptionKind.aspect_ratio, code="4_3", label="4:3",
         provider_params={"aspect_ratio": "4:3"},
         credits_multiplier=1.0, is_default=False, sort_order=40),
    ...
    #    ни num_frames); влияние resolution на цену не мерили -- но цена плоская
    #    ($0.20/видео), поэтому resolution-пары заведены как формат кадра выше.
]
...
BANNERS = [
    dict(
        ...
        image_url="/banners/banner-bg-1.jpg",
        action_type="prompt",
    ...
    dict(
        ...
        image_url="/banners/banner-bg-2.jpg",
        action_type="prompt",
