...
// Зеркалит расчёт стоимости на бэкенде (app/api/routes/chat.py) -- только для
// мгновенного отображения цены в UI, реальная стоимость всегда пересчитывается на сервере.
